...
if st.session_state.product_info:
    ...
    with col2:
        ...
        # <<< ADIÇÃO: Exibe a descrição do produto em um "expander"
        if description := info.get("product_description"):
            with st.expander("Ver Descrição Completa do Produto"):
    ...
    with tab2:
        ...
        if st.button("Gerar Listing Otimizado com IA", key="optimize_btn", use_container_width=True):
            # ... (código da otimização permanece o mesmo)
            pass 
